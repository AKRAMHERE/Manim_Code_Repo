...
class MatrixRotationWithMath(Scene):
    def construct(self):
        ...
        # Algorithmic Explanation with visuals
        self.explain_algorithm_with_visuals()
        ...
        # Show Example 2 (FULL VISUALIZATION INCLUDED)
        ...
        self.wait(3)
        self.play(FadeOut(example2_title))
        self.clear_screen()
        # Show Python Code Explanation
        self.show_code()
        self.wait(7)
    def show_example(self, initial_matrix, transposed_matrix, rotated_matrix):
        """Handles step-by-step visualization of the matrix rotation process."""
    ...
    def clear_screen(self):
        """Clears the screen by fading out all objects."""
    ...
    def explain_algorithm_with_visuals(self):
        
        # Algorithmic Explanation
        algorithm_text = Tex(r"\textbf{Algorithmic Steps:}", font_size=42).to_edge(UP)
        step1 = Tex(r"1. \textbf{Transpose the Matrix}", font_size=36)
        step2 = Tex(r"2. \textbf{Reverse Each Row}", font_size=36)
        steps = VGroup(step1, step2).arrange(DOWN, buff=0.5)
        ...
        self.play(FadeIn(steps))
        self.wait(2)
        self.play(FadeOut(algorithm_text), FadeOut(steps))

    def create_matrix(self, matrix, title_text):
        """Creates a VGroup for a matrix with a title."""   
        title = Tex(title_text, font_size=40)
        ...
        return VGroup(title, elements, matrix_box)
    
    def show_code(self):
        """Displays Python code explanation for the matrix rotation algorithm."""
        code_text = Tex(r"\textbf{Python Code:}", font_size=42).to_edge(UP)
        python_code = Code(
            code=""" 
        def rotate(matrix): 
            n = len(matrix) 
...
if __name__ == "__main__":
    os.system("manim -pqh mce/lc04_03.py MatrixRotationWithMath")
